...
class TeleopIphone : public rclcpp::Node {
   ...
   private:
    ...
    void control_timer_callback() {
        ...
        cmd_msg.target_pose.orientation.x = target_quat.x();
        cmd_msg.target_pose.orientation.y = target_quat.y();
        cmd_msg.target_pose.orientation.z = target_quat.z();
        cmd_msg.target_pose.orientation.w = target_quat.w();
